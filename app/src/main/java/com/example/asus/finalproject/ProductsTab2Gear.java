...
public class ProductsTab2Gear extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.products_tab2_gear, container, false);
        mAuth = FirebaseAuth.getInstance();
        mDatabase = FirebaseDatabase.getInstance().getReference();
        mDatabaseGearPosts = mDatabase.child("GearPosts");
        mDatabaseLike = mDatabase.child("Likes");

        recyclerView = (RecyclerView) rootView.findViewById(R.id.products_gear_RV);

        mDatabaseGearPosts.keepSynced(true);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Posts, BlogViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Posts, BlogViewHolder>(
                Posts.class,
                R.layout.products_gear_blog_row,
