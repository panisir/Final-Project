...
public class ProductsTab3Others extends Fragment {

    private FirebaseAuth mAuth;
    private DatabaseReference mDatabase;
    private DatabaseReference mDatabaseLike;
    private DatabaseReference mDatabaseOthersPosts;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.products_tab3_others, container, false);

        mAuth = FirebaseAuth.getInstance();
        mDatabase = FirebaseDatabase.getInstance().getReference();
        mDatabaseOthersPosts = mDatabase.child("OtherPosts");
        mDatabaseLike = mDatabase.child("Likes");


        recyclerView = (RecyclerView) rootView.findViewById(R.id.products_others_RV);

        mDatabaseOthersPosts.keepSynced(true);
